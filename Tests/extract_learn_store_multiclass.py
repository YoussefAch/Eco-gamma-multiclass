...
"""
    ...
    Just save probabilities vector instead of one value each time
"""
...
# datasets = ["CBF", "ChlorineConcentration", "CinCECGTorso", "Crop", "ECG5000", "ECGFiveDays", "ElectricDevices", "FaceAll", "FacesUCR", "FiftyWords", "FordA", "FreezerRegularTrain", "HandOutlines", "ItalyPowerDemand","InsectWingbeatSound" "Mallat", "MedicalImages", "MelbournePedestrian", "MixedShapesRegularTrain", "MoteStrain", "NonInvasiveFatalECGThorax2", "PhalangesOutlinesCorrect", "ProximalPhalanxOutlineCorrect", "SemgHandGenderCh2", "SonyAIBORobotSurface2", "StarLightCurves", "Strawberry", "Symbols", "TwoLeadECG", "TwoPatterns", "UWaveGestureLibraryX", "Wafer", "WordSynonyms", "Yoga"]
# datasets = ["ProximalPhalanxOutlineCorrect"]

datasets = ["50words", "Adiac", "Beef", "CBF", "ChlorineConcentration", "CinC_ECG_torso", "Coffee", "Cricket_X", "Cricket_Y", "Cricket_Z", "DiatomSizeReduction", "ECG200", "ECGFiveDays", "FaceAll", "FaceFour", "FacesUCR", "FISH", "Gun_Point", "Haptics", "InlineSkate", "ItalyPowerDemand", "Lighting2", "Lighting7", "MALLAT", "MedicalImages", "MoteStrain", "OliveOil", "OSULeaf", "SonyAIBORobotSurface", "SonyAIBORobotSurfaceII", "StarLightCurves", "SwedishLeaf", "Symbols", "Synthetic_control", "Trace", "TwoLeadECG", "Two_Patterns", "uWaveGestureLibrary_X", "uWaveGestureLibrary_Y", "uWaveGestureLibrary_Z", "Wafer", "WordsSynonyms", "Yoga", "NonInvasiveFatalECG_Thorax1", "NonInvasiveFatalECG_Thorax2"]
...
for k,dataset in enumerate(datasets):
    ...
    for t in timestamps:
        ...
        # MOD : now save full classifier output vector
