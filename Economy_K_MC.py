...
class Economy_K_MC(Economy):
    ...
    def __init__(self, misClassificationCost, timeCost, min_t, classifier, nbClusters, sampling_ratio, use_complete_ECO_model, pathECOmodel, fears, dataset , feat, folderRealData):
            ...
            if (len(indices_ck)>0):
                ...
                if self.fears:
                    ...
                    with open(op.join(self.folderRealData,self.dataset,'ep_preds_'+str(timestep)+'.pkl') ,'rb') as inp:
                        ...
                        # print(len(predictions),len(clusters_data))
